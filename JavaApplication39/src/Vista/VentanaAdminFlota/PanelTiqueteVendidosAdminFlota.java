...
public class PanelTiqueteVendidosAdminFlota extends javax.swing.JPanel {
    ...
    /**
     * Creates new form VentanaPrincipalTiqueteVendidosAdminFlota
     */
    ...
    private void llenarTabla(){
        DefaultTableModel model = new DefaultTableModel();
         ...
         for (int i = 0; i < controladorEmpresa.getEmpresa().getListaViajes().get(i).getListaTiquetes().size(); i++) {
             model.addRow(new Object[]{
                controladorEmpresa.getEmpresa().getListaViajes().get(i).getListaTiquetes().get(i).getCodigo(),
                controladorEmpresa.getEmpresa().getListaViajes().get(i).getListaTiquetes().get(i).getCliente().getNombre(),
                controladorEmpresa.getEmpresa().getListaViajes().get(i).getListaTiquetes().get(i).getFechaDeCompra(),
                controladorEmpresa.getEmpresa().getListaViajes().get(i).getListaTiquetes().get(i).getHoraDeCompra(),
                controladorEmpresa.getEmpresa().getListaViajes().get(i).getListaTiquetes().get(i).getViaje().getDestino(),
             });
         }
